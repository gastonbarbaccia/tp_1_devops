...
<head>
  ...
  <title>Gestión de la privacidad | Datos personales </title>
      ...
      <section class="content">
        ...
        <div class="card-body ">
          <div style="margin-top:3%;margin-left:3%;">
            <div class="mb-3 row">
              <label for="staticName" class="col-sm-2 col-form-label">Usuario</label>
              <div class="col-sm-3">
                <input type="text" class="form-control" id="staticName" value="gastonhamachi" readonly>
              </div>
            </div>
            <div class="mb-3 row">
              <label for="staticName" class="col-sm-2 col-form-label">Nombre</label>
              <div class="col-sm-3">
                <input type="text" class="form-control" id="staticName" value="Gaston">
              </div>
            </div>
            <div class="mb-3 row">
              <label for="staticLastname" class="col-sm-2 col-form-label">Apellido</label>
              <div class="col-sm-3">
                <input type="text" class="form-control" id="staticLastname" value="Hamachi">
              </div>
            </div>
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
              <label for="inputPassword" class="col-sm-2 col-form-label">Reestablecer contraseña</label>
              <div class="col-sm-3">
