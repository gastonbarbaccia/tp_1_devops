...
<head>
  ...
  <title>Gestión de la privacidad | Inicio </title>
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        ...
        <div class="card-header">
          <h3 class="card-title"><b>Seleccione el trámite a realizar:</b></h3>
        </div>
        <!-- /.card-header -->

        <div class="card-body table-responsive p-0">
          <div style="margin-top:3%;margin-left:3%;">
            <a href="nuevo_tramite.php"><img src="img/tramite.PNG" style="border-radius: 30px;width:100px;height:100px"><label style="margin-left:2%">Evaluación de Impacto en la protección de datos personales</label></a>
          </div>
        </div>
      </section>
    </div>
